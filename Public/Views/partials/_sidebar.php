    ...
    <div class="h-100">
        ...
        <ul class="sidebar_nav">
            <li class="sidebar_item active" style="width: 100%;">
                <a href="dashboard.php" class="sidebar_link"> <img src="dashboard/img/1. overview.svg" alt="icon">Dashboard</a>
            </li>
            <li class="sidebar_item">
                <a href="jobs.php" class="sidebar_link"> <img src="dashboard/img/task.svg" alt="icon">Job Offers</a>
            </li>
            <li class="sidebar_item">
                <a href="applications.php" class="sidebar_link"> <img src="dashboard/img/agents.svg" alt="icon">Applications</a>
            </li>
            <li class="sidebar_item">
